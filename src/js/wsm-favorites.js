(function(window, angular) {
    ...
    ngWsmFavorites.directive('wsmFavorites', ['$ngWsmFavorites', function($ngWsmFavorites) {
	...
	ngWsmFavorites.directive('wsmFavoritesTotal', ['$ngWsmFavorites', function($ngWsmFavorites) {
